...
echo '<form method="post" action="includes/tallennatiedot.php">
	...
	<label>Puhelinnumero</label><input type="text" name="puhelinnumero"placeholder="'.$_SESSION['puhelin'].'"><button type="submit" name="btn_puhelin">Tyhjennä</button><br>
	<label>Koulutus</label><input type="text" name="koulutus"placeholder="'.$_SESSION['koulutus'].'"><button type="submit" name="btn_koulutus">Tyhjennä</button><br>
