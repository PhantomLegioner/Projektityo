...
<div class="row py-5 px-4">
    <div class="col-xl-4 col-md-6 col-sm-10 mx-auto">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 bg-dark">
                <div class="media align-items-end profile-header">
                    <div class="profile mr-3"><img src="REETTA.jpg" alt="..." width="130" class="rounded mb-2 img-thumbnail"><a href="#" class="btn btn-dark btn-sm btn-block">Edit profile</a></div>
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0">REETTA EERIKÄINEN</h4>
	  ...
	  <!--   Nyt alkaa footer eli sivuston alaosa. Noin kolmasosa korkeudeltaan -->
	 	  <div class="footer">
	    <div class="row">
   <img src="kuvat/logo.jpg" class="float-left" alt="Paris" width="500" height="250">
  <img src="kuvat/oikeudet.jpg" class="float-right" alt="Paris" width="500" height="250">
  </div>
